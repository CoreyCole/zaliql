...
Finally, we will demonstrate performance improvements relative to R. As seen in Figure \ref{sfig:demo-tutorial}(g), with only 4M rows, R takes 20 minutes compared to \GSQL\'s performance of less than 1 minute. 
