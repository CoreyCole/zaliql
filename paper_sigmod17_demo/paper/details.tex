...
\GSQL\ is able to run through 105M entries in less than a minute, whereas for CEM, in R, SPSS or SAS,
 takes several minutes on 5M entries. \footnote{We note that \GSQL\ is recognised as a scalable
 ...
 Here for the benefit of space we restrict the scalability comparison with R and Stata.} 
