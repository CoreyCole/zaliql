...
\end{example}
 ...
 on flight departure delay. For example, we show that \%11 of flights were delayed
when pressure was low; but only \%0.4 of flights delayed
when pressure was high. This suggests that pressure strongly affects flight delays.
However, when examining departure delay, by airports, airline and other weather features, 
the flight delay rate-upon
low pressure-declined to less than \%0.001 in all the groups. \footnote{This phenomenon
...
\hspace*{.3cm}\includegraphics[scale=0.18]{figures/Scenario-Graph.png}
...
\GSQL\ is able to run through 105M entries in less than a minute, whereas for CEM, in R, SPSS or SAS,
 ...
 counterpart of CEM by its inventors (see, \url{http://gking.harvard.edu/cem}).} Because of the lack of 
 space we only compare \GSQL\ with R and Stata. However, \GSQL\ 
 outperforms other statistical softwares too.
