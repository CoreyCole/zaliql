...
as shown in Fig. \ref{sfig:demo-tutorial}(a).
 \vspace{-0.33cm} \item specifying a set of binary treatments (causes) that might affect DepDelay,
...
Tempm< 0$) and input SQL for custom discretization methods.}
    \vspace{-0.6cm} \item specifying a subset of data that is relevant to the analysis.  We select five US airports  with high rate of weather-related delay, namely,
