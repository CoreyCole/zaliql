...
Finally, we will demonstrate the performance improvements relative to R. As seen in Figure \ref{fig:demo-tutorial}(g), with only 4M rows, R takes 20 minutes compared to \GSQL\'s performance of less than 1 minute. 
