...
\end{figure*}
 ...
 taking the  average difference for each group \danp{Need to define
...
\danp{reiterate that we want to compute ATE by calculating the difference over a set of balanced groups}
