...
\danp{Can we add an example to make this more intuitive, since it's important e.g.: each individual flight has either
  LowPressure=1 or =0, not both}
...
\danp{Can we explain the strengths and weaknesses of each, or at least
  say that all three are commonly used. As it is, it sounds like
  subclassification is strictly better than NNM - and if so why did we
  implement both?}
