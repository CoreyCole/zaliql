...
have:  ATE = $\E[Y(1)|T=1]-\E[Y(0)|T=0]$. \GSQL\  is designed for drawing causal inference from {\em
  observational data}, where the mechanism used to assign treatments
to units is not known, and where independence fails in general. \ignore{
For
...
statistics is {\em approximate matching}~\cite{Rubin1983b}.  The idea is to match each treated unit with one or multiple control
