...
\GSQL\ estimate propensity score by perfroming ,logistic regression with
 UDF (User-Defined Function) inside PostgreSQL. 
\ignore{
...
is depicted in Figure \ref{fig:nnmnr}.
In this solution,
...
However, \GSQL\  generate more efficient SQl statements by
...
To perform CEM efficiently, \GSQL\ leverages techniques from data management
 including pushing aggregates down to the base relation,
  ...
  bitmap indices. \GSQL\  also include several discretization methods for coarsening.
