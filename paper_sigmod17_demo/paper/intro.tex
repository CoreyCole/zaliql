...
To this day, {\em randomized experiments (A/B testing)} remain the gold standard for causal inference. However, in many domains controlled experiments are not feasible for ethical, economical or practical reasons \cite{rosenbaum2002observational}. Causal inference in the lack of controlled experiment is called {\em observational studies} \cite{Fisher1935design,Rubin2005,holland1986statistics,PearlBook2000\ignore{,Spirtes:book01}}. While social scientists and economists have been
using observational data for policy development over a century, the business world only recently discovering the emerging potential of Big Data, which is strictly observational in nature.
...
Thus, supporting scalable and valid techniques to draw causal conclusions from Big Data is a key toward getting sustainable insights from data. \ignore{ in decision support systems.}
