...
Today, causal inferece from observational data is performing with toolkits that depends on statistical software such as R, SPSS and SAS e.g., MatchIt and CEM \cite{ho2005,iacus2009cem}.  However, these toolkits  are designed for single table data and do not scale to large datasets. For example, performing causal inference  on a dataset with 10M entries takes several hours using MatchIt or CEM.
