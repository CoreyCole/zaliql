...
distributions of the confounding variables (a.k.a covariates) in the groups are more similar. A typical workfellow of causal inference via matching is shown in Figure \ref{fig:flowchart}. 
