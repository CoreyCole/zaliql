...
\title{\vspace*{-1cm} {\bf ZaliQL: A SQL-Based Framework for Drawing Causal Inference from Big Data}}
\author{{\bf Babak Salimi} \ \ and \ \ {\bf Dan Suciu}\\
Department of Computer Science \& Engineering\\  Seattle,  USA\\
\hspace*{1.5cm}\{bsalimi, suciu\}@cs.washington.edu
}
