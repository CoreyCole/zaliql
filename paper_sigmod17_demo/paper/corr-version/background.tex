...
$\ldots$&       &       &  & & \\
  ...
  \caption{\bf{The Neyman-Rubin Causal Model (NRCM).}}
  \label{fig:causal:inference}
\end{table*}



\paragraph*{\bf{Average Treatment Effect (ATE)}}
...
\paragraph*{\bf{Observational Data}}
...
\paragraph*{\bf{Matching}} We briefly describe matching
