...
DECLARE
  ...
  qq_json JSONB;
BEGIN
  SELECT get_json_covariate_stats(original_table, treatment, original_covariates_arr)
    INTO all_json;
  SELECT get_json_covariate_stats(matchit_cem_table, treatment, binned_ordinal_covariates_arr)
    INTO matched_json;
  SELECT ate_cem(original_table, matchit_cem_table, treatment, outcome, grouping_attribute, original_ordinal_covariates_arr)
    INTO ate_json;
  SELECT qq_cem(original_table, matchit_cem_table, treatment, original_ordinal_covariates_arr, binned_ordinal_covariates_arr)
    INTO qq_json;
