...
generates a hypothesis, pre-processes the data with a matching  method (explained below), and then finally
 conducts the causal analysis. Frequently, this process needs to be repeated with a new matching
  method, a new hypothesis or new datasets \cite{IacKinPor09}. Our system does not address statistical validity of multiple hypothesis testing. 
...
(closeness is defined using some distance function between the covariate values of two units) \cite{iacus2009cem}.
\ignore{
