...
{\em Observational studies} can be used to draw causal inference without controlled experiments  \cite{rosenbaum2002observational,Rubin2005\ignore{,PearlBook2000,Spirtes:book01}}. Computational, physical, and social scientists all increasingly want to perform causal inference on big data from observational studies:
...
\bibliography{p1235-salimi}  % vldb_sample.bib is the name of the Bibliography in this case
