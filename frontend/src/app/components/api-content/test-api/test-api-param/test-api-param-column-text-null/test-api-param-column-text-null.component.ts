...
@Component({
  selector: 'zql-test-api-param-column-text-null',
  styleUrls: ['./test-api-param-column-text-null.component.scss'],
  template: `
<mat-form-field>
...
<mat-form-field *ngIf="selectedTable !== 'null'">
  <mat-select
    #selectedColumn
...
export class TestApiParamColumnTextNullComponent implements OnInit {
  @Input() paramData;
